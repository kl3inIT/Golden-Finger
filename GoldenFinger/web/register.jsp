                ...
                <div class="w-full px-[12px]">
                    <div class="flex flex-wrap m-0 p-[15px] border-[1px] border-solid border-[#eee] rounded-b-[5px] border-t-[0] gi_breadcrumb_inner">
                        <div class="min-[768px]:w-[50%] w-full px-[12px]">
                            <h2 class="gi-breadcrumb-title text-[#4b5966] block text-[15px] font-Poppins leading-[22px] font-semibold my-[0] mx-auto capitalize max-[767px]:mb-[5px] max-[767px]:text-center">Register Page</h2>
                        </div>
                        <div class="min-[768px]:w-[50%] w-full px-[12px]">
                            ...
                            <ul class="gi-breadcrumb-list text-right max-[767px]:text-center">
                                ...
                                <li class="gi-breadcrumb-item inline-block text-[14px] font-normal tracking-[0.02rem] leading-[1.2] capitalize active">Register Page</li>
                            </ul>
                        ...
                        <div class="gi-register-form">
                            <form action="#" method="post" class="flex flex-row flex-wrap mx-[-15px]">
                                ...
                                <span class="gi-register-wrap gi-register-half w-[50%] px-[15px]">
                                    ...
                                    <input type="password" name="password" placeholder="Enter your email add..."
                                        class="w-full bg-transparent border-[1px] border-solid border-[#eee] text-[#777] text-[14px] mb-[26px] px-[15px] outline-[0] rounded-[5px] h-[50px]"
                                        required>
                                </span>
                                <span class="gi-register-wrap gi-register-half w-[50%] px-[15px]">
                                    ...
                                    <input type="password" name="comfirmpassword" placeholder="Enter your phone number"
                                        class="w-full bg-transparent border-[1px] border-solid border-[#eee] text-[#777] text-[14px] mb-[26px] px-[15px] outline-[0] rounded-[5px] h-[50px]"
                                        required>
                                </span>
                                <span class="gi-register-wrap gi-register-half w-[50%] px-[15px]">
                                ...
                                <span class="gi-register-wrap gi-register-half w-[50%] px-[15px]">
                                    <label
                                        ...
                                        *</label>
                                    <input type="text" name="phone" placeholder="Enter your full name"
                                        class="w-full bg-transparent border-[1px] border-solid border-[#eee] text-[#777] text-[14px] mb-[26px] px-[15px] outline-[0] rounded-[5px] h-[50px]"
                                        required>
                                </span>
                                <span class="gi-register-wrap gi-register-half w-[50%] px-[15px]">
                                ...
                                <span class="gi-register-wrap gi-register-half w-[50%] px-[15px]">
                                    <label
                                        ...
                                        *</label>
                                    <input type="text" name="address" placeholder="Enter your full name"
                                        class="w-full bg-transparent border-[1px] border-solid border-[#eee] text-[#777] text-[14px] mb-[26px] px-[15px] outline-[0] rounded-[5px] h-[50px]"
                                        required>
                                </span>
                                ...
                                <span class="gi-register-wrap gi-recaptcha w-full flex justify-center px-[15px]">
                                    ...
                                    <input
                                        class="form-control hidden w-full bg-transparent border-[1px] border-solid border-[#eee] text-[#777] text-[14px] mb-[26px] px-[15px] outline-[0] rounded-[5px] h-[50px]"
