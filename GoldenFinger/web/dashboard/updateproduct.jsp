                                                ...
                                                <div class="gi-vendor-upload-detail">
                                                    <div class="row g-3">
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="text" class="form-control slug-title" id="" name="name" value="${p.name}" required >
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label class="form-label">Quantity</label>
                                                            <input type="number" class="form-control" id="quantity1" name="quantity" value="${p.unitInStock}" required>
                                                        </div>
                                                        <div class="col-md-6">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="number" min="0" max="1" step="0.01" class="form-control" id="quantity1" name="discount" value="${p.discount}" required>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label class="form-label">Include</label>
                                                            <input type="text" class="form-control" id="quantity1" name="include" value="${p.include}" required>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label for="" class="form-label">Warranty</label>
                                                            <input type="text" class="form-control slug-title" name="warranty" value="${p.warranty}" id="" required>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label for="" class="form-label">Dimension</label>
                                                            <input type="text" class="form-control slug-title" name="demension" value="${p.dimensions}"  id="" required>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label for="" class="form-label">Weight</label>
                                                            <input type="text" class="form-control slug-title" name="weight" value="${p.weight}"  id="" required>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label for="" class="form-label">Speaker</label>
                                                            <input type="text" class="form-control slug-title" name="speaker" id="" value="${not empty p.speakerPower ? p.speakerPower : 'none'}" required>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label for="" class="form-label">Release Date</label>
                                                            <input type="date" class="form-control slug-title" name="date" id="" value="${p.releaseDate}" required>
                                                        </div>


                                                        <div class="col-md-12">
                                                            <label class="form-label">Ful Detail</label>
                                                            <textarea class="form-control" rows="4" name="detail" required>${p.describe}</textarea>
                                                        </div>
